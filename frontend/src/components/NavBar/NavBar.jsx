...
export default function NavBar({SetPage, logout,active}){
    ...
    return(
    <div className="w-full h-12 py-2 text-center font-semibold text-xl shadow-md border-b-2">
        ...
        <a className={"duration-150 "+(active==3 ? "nav-a-item" : "nav-item")} onClick={()=>{ SetPage(3);}}>Goals</a>
